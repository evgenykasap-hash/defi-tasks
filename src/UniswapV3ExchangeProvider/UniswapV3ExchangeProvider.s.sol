...
contract DeployUniswapV3ExchangeProvider is Script {
    function run() public {
        ...
        console.log("Singlehop pairs configured:", UniswapV3ExchangeProviderConfig.getDefaultSinglehopPairs().length);
        console.log("Multihop pairs configured:", UniswapV3ExchangeProviderConfig.getDefaultMultihopPairs().length);
